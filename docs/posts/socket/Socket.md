...
![img.png](https://revi1337.github.io/posts/socket/img.png)
<br><br>
...
![img_1.png](https://revi1337.github.io/posts/socket/img_1.png)
<br><br>

우선 메인페이지를 가면 `QRCode` 를 `PlainText` 로 이루어진 `PNG` 로 변환시켜주는 기능과 그 반대의 역할을 하는 기능을 가진 사이트로 보인다.

![img_2.png](https://revi1337.github.io/posts/socket/img_2.png)
<br><br>
...
![img_3.png](https://revi1337.github.io/posts/socket/img_3.png)
<br><br>
...
![img_4.png](https://revi1337.github.io/posts/socket/img_4.png)
![img_5.png](https://revi1337.github.io/posts/socket/img_5.png)
<br><br>

`SSTI` 를 테스트하고 있던 도중 특이한점을 발견했는데, 웹에서 `QRCode` 를 생성하거나 `PNG` 로 변환하는 작업을하면, 아래의 `Total Convertions` 을 횟수가 변한다는 것이다.

![img_6.png](https://revi1337.github.io/posts/socket/img_6.png)
<br><br>

`Burp` 에서 보았을때는 Total Convertions 와 관련된 파라미터를 볼 수 없었기 때문에, 문제의 제목인 `Socket` 과 `nmap` 에서 얻은 Unknown 서비스를 사용하고 있을 수도 있다 추측할 수 있다.

![img_7.png](https://revi1337.github.io/posts/socket/img_7.png)
<br><br>

이제 직접 `5789` 포트에 연결해보면 `Python websocket` 을 사용중임을 확인할 수 있다.

![img_8.png](https://revi1337.github.io/posts/socket/img_8.png)
<br>
...
![img_9.png](https://revi1337.github.io/posts/socket/img_9.png)
<br><br>

발생한 오류를 토대로 따라가서 `ws://10.10.11.206:5789/update` 에 요청을 보내면 다운받을 수 있는 버전 정보가 나오게 된다.

![img_10.png](https://revi1337.github.io/posts/socket/img_10.png)
<br><br>
...
![img_11.png](https://revi1337.github.io/posts/socket/img_11.png)
<br><br>
...
![img_12.png](https://revi1337.github.io/posts/socket/img_12.png)
<br><br>
...
![img_13.png](https://revi1337.github.io/posts/socket/img_13.png)
<br><br>
...
![img_14.png](https://revi1337.github.io/posts/socket/img_14.png)
<br><br>
...
![img_15.png](https://revi1337.github.io/posts/socket/img_15.png)
<br><br>
...
![img_16.png](https://revi1337.github.io/posts/socket/img_16.png)
<br><br>

얻은 계정정보를 `CrackStation` 에 크랙을 맡겨주면 `denjanjade122566` 패스워드임을 확인할 수 있다.

![img_17.png](https://revi1337.github.io/posts/socket/img_17.png)
<br><br>
